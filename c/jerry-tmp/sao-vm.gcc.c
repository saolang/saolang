...
# 1 "./jrt.h" 1
# 22 "./jrt.h"
# 1 "./jerryscript-port.h" 1
# 19 "./jerryscript-port.h"
...
# 20 "./jerryscript-port.h" 2



# 1 "./jerryscript-compiler.h" 1
# 24 "./jerryscript-port.h" 2
# 48 "./jerryscript-port.h"
typedef enum
{
...
# 68 "./jerryscript-port.h"
void __attribute__((noreturn)) jerry_port_fatal (jerry_fatal_code_t code);
# 78 "./jerryscript-port.h"
typedef enum
{
...
# 107 "./jerryscript-port.h"
void __attribute__((format(printf, 2, 3))) jerry_port_log (jerry_log_level_t level, const char *format, ...);
# 144 "./jerryscript-port.h"
double jerry_port_get_local_time_zone_adjustment (double unix_ms, _Bool is_utc);
# 157 "./jerryscript-port.h"
double jerry_port_get_current_time (void);
# 170 "./jerryscript-port.h"
struct jerry_context_t *jerry_port_get_current_context (void);
# 181 "./jerryscript-port.h"
...
# 119 "./jrt.h"
void __attribute__((noreturn)) jerry_fatal (jerry_fatal_code_t code);
# 21 "./ecma-globals.h" 2
# 1 "./lit-magic-strings.h" 1
# 19 "./lit-magic-strings.h"
# 1 "./lit-globals.h" 1
# 74 "./lit-globals.h"
...
# 1 "./lit-magic-strings.inc.h" 1
# 20 "./lit-magic-strings.inc.h"
...
# 159 "./jmem.h"
jmem_cpointer_t __attribute__((pure)) jmem_compress_pointer (const void *pointer_p);
void * __attribute__((pure)) jmem_decompress_pointer (uintptr_t compressed_pointer);
...
# 36 "./common.h" 2
# 1 "./ecma-regexp-object.h" 1
# 22 "./ecma-regexp-object.h"
# 1 "./re-compiler.h" 1
# 22 "./re-compiler.h"
# 1 "./re-bytecode.h" 1
# 46 "./re-bytecode.h"
...
uint32_t __attribute__((pure)) re_get_bytecode_length (re_bytecode_ctx_t *bc_ctx_p);
...
# 23 "./ecma-regexp-object.h" 2
# 36 "./ecma-regexp-object.h"
typedef enum
{
  RE_FLAG_GLOBAL = (1u << 1),
...
# 8 "sao-vm.c" 2
# 1 "./ecma-array-object.h" 1
# 31 "./ecma-array-object.h"
typedef enum
{
...
{
# 34 "./ecma-builtins.h"
# 1 "./ecma-builtins.inc.h" 1
# 27 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_OBJECT,
# 42 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_ARRAY,
# 58 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_STRING,
# 74 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_BOOLEAN,
# 90 "./ecma-builtins.inc.h"
...
# 138 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_DATE,
# 154 "./ecma-builtins.inc.h"
...
# 184 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_EVAL_ERROR,
# 198 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_RANGE_ERROR,
# 212 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_REFERENCE_ERROR,
# 226 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_SYNTAX_ERROR,
# 240 "./ecma-builtins.inc.h"
ECMA_BUILTIN_ID_TYPE_ERROR,
# 254 "./ecma-builtins.inc.h"
...
# 10 "sao-vm.c" 2
# 1 "./ecma-comparison.h" 1
# 20 "./ecma-comparison.h"
# 1 "./ecma-helpers.h" 1
# 21 "./ecma-helpers.h"
# 1 "./lit-strings.h" 1
# 88 "./lit-strings.h"
...
# 141 "./ecma-helpers.h"
_Bool __attribute__((const)) ecma_is_value_direct (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_simple (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_empty (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_undefined (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_null (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_boolean (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_true (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_false (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_found (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_array_hole (ecma_value_t value);

_Bool __attribute__((const)) ecma_is_value_integer_number (ecma_value_t value);
_Bool __attribute__((const)) ecma_are_values_integer_numbers (ecma_value_t first_value, ecma_value_t second_value);
_Bool __attribute__((const)) ecma_is_value_float_number (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_number (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_string (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_direct_string (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_non_direct_string (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_object (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_error_reference (ecma_value_t value);
_Bool __attribute__((const)) ecma_is_value_pointer (ecma_value_t value);

void ecma_check_value_type_is_spec_defined (ecma_value_t value);

ecma_value_t __attribute__((const)) ecma_make_boolean_value (_Bool boolean_value);
ecma_value_t __attribute__((const)) ecma_make_integer_value (ecma_integer_value_t integer_value);
...
ecma_value_t __attribute__((pure)) ecma_make_string_value (const ecma_string_t *ecma_string_p);
ecma_value_t __attribute__((pure)) ecma_make_magic_string_value (lit_magic_string_id_t id);
ecma_value_t __attribute__((pure)) ecma_make_object_value (const ecma_object_t *object_p);
ecma_value_t __attribute__((pure)) ecma_make_error_reference_value (const ecma_error_reference_t *error_ref_p);
ecma_value_t __attribute__((pure)) ecma_make_pointer_value (const void *any_p);
ecma_integer_value_t __attribute__((const)) ecma_get_integer_from_value (ecma_value_t value);
ecma_number_t __attribute__((pure)) ecma_get_float_from_value (ecma_value_t value);
ecma_number_t __attribute__((pure)) ecma_get_number_from_value (ecma_value_t value);
ecma_string_t __attribute__((pure)) *ecma_get_string_from_value (ecma_value_t value);
ecma_object_t __attribute__((pure)) *ecma_get_object_from_value (ecma_value_t value);
ecma_error_reference_t __attribute__((pure)) *ecma_get_error_reference_from_value (ecma_value_t value);
void * __attribute__((pure)) ecma_get_pointer_from_value (ecma_value_t value);
ecma_value_t __attribute__((const)) ecma_invert_boolean_value (ecma_value_t value);
...
lit_utf8_size_t __attribute__((warn_unused_result))
...
_Bool __attribute__((pure)) ecma_is_lexical_environment (const ecma_object_t *object_p);
_Bool __attribute__((pure)) ecma_get_object_extensible (const ecma_object_t *object_p);
void ecma_set_object_extensible (ecma_object_t *object_p, _Bool is_extensible);
ecma_object_type_t __attribute__((pure)) ecma_get_object_type (const ecma_object_t *object_p);
ecma_object_t __attribute__((pure)) *ecma_get_object_prototype (const ecma_object_t *object_p);
_Bool __attribute__((pure)) ecma_get_object_is_builtin (const ecma_object_t *object_p);
void ecma_set_object_is_builtin (ecma_object_t *object_p);
uint8_t ecma_get_object_builtin_id (ecma_object_t *object_p);
ecma_lexical_environment_type_t __attribute__((pure)) ecma_get_lex_env_type (const ecma_object_t *object_p);
ecma_object_t __attribute__((pure)) *ecma_get_lex_env_outer_reference (const ecma_object_t *object_p);
ecma_property_header_t __attribute__((pure)) *ecma_get_property_list (const ecma_object_t *object_p);
ecma_object_t __attribute__((pure)) *ecma_get_lex_env_binding_object (const ecma_object_t *object_p);
...
# 11 "sao-vm.c" 2
# 1 "./ecma-conversion.h" 1
# 33 "./ecma-conversion.h"
typedef enum
{
...
# 12 "sao-vm.c" 2
# 1 "./ecma-exceptions.h" 1
# 40 "./ecma-exceptions.h"
typedef enum
{
  ECMA_ERROR_NONE,
...
# 13 "sao-vm.c" 2
# 1 "./ecma-function-object.h" 1
# 20 "./ecma-function-object.h"
# 1 "./vm.h" 1
# 21 "./vm.h"
# 1 "./vm-defines.h" 1
# 18 "./vm-defines.h"
...
# 19 "sao-vm.c" 2
# 1 "./ecma-objects-general.h" 1
# 29 "./ecma-objects-general.h"
...
# 1 "./ecma-try-catch-macro.h" 1
# 22 "sao-vm.c" 2
# 1 "./jcontext.h" 1
# 22 "./jcontext.h"
# 1 "./debugger.h" 1
# 20 "./debugger.h"
# 1 "./jerryscript-debugger-transport.h" 1
# 20 "./jerryscript-debugger-transport.h"
# 1 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.1.0/include/stddef.h" 1 3 4
# 21 "./jerryscript-debugger-transport.h" 2
# 40 "./jerryscript-debugger-transport.h"
typedef struct
{
  uint8_t *buffer_p;
...
# 1 "./jerryscript.h" 1
# 19 "./jerryscript.h"
# 1 "./jerryscript-core.h" 1
# 20 "./jerryscript-core.h"
# 1 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.1.0/include/stddef.h" 1 3 4
# 21 "./jerryscript-core.h" 2
# 47 "./jerryscript-core.h"
typedef enum
{
  JERRY_INIT_EMPTY = (0u),
...
# 272 "./jerryscript-core.h"
  void (*deinit_cb) (void *data);
# 283 "./jerryscript-core.h"
...
# 20 "./jerryscript.h" 2
# 1 "./jerryscript-debugger.h" 1
# 39 "./jerryscript-debugger.h"
typedef enum
{
...
# 21 "./jerryscript.h" 2
# 1 "./jerryscript-snapshot.h" 1
# 38 "./jerryscript-snapshot.h"
typedef enum
{
  ...
  ecma_value_t property)
{
 ...
 if (__builtin_expect(!!(ecma_is_value_undefined (object) || ecma_is_value_null (object)), 0))
 {
 ...
 if ((__builtin_expect(!!((prop_to_string_result) == ECMA_VALUE_ERROR), 0)))
 {
...
vm_op_set_value (ecma_value_t object,
  ...
  _Bool is_strict)
{
 if (__builtin_expect(!!(!ecma_is_value_object (object)), 0))
 {
  ecma_value_t to_object = ecma_op_to_object (object);
  ecma_free_value (object);

  if ((__builtin_expect(!!((to_object) == ECMA_VALUE_ERROR), 0)))
  {
# 135 "sao-vm.c"
 ...
 if (!ecma_is_value_string (property))
 {
  ...
  if ((__builtin_expect(!!((to_string) == ECMA_VALUE_ERROR), 0)))
  {
   ecma_free_value (object);
   return to_string;
  }
...
# 322 "sao-vm.c"
 if (!(bytecode_p->status_flags & CBC_CODE_FLAGS_FUNCTION))
 {
  ...
  if ((__builtin_expect(!!((ret_value) == ECMA_VALUE_ERROR), 0)))
  {
 ...
 do { if (__builtin_expect(!!(!(bytecode_p->status_flags & CBC_CODE_FLAGS_FUNCTION)), 0)) { jerry_assert_fail ("bytecode_p->status_flags & CBC_CODE_FLAGS_FUNCTION", "sao-vm.c", __func__, 337); } } while (0);
 ...
 static inline _Bool __attribute__((always_inline))
vm_get_implicit_this_value (ecma_value_t *this_value_p)
{
 if (ecma_is_value_object (*this_value_p))
 {
  ...
  if (ecma_is_lexical_environment (this_obj_p))
  {
   ...
   do { if (__builtin_expect(!!(!(!(__builtin_expect(!!((completion_value) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("!ECMA_IS_VALUE_ERROR (completion_value)", "sao-vm.c", __func__, 377); } } while (0);
...
{
 do { if (__builtin_expect(!!(!(frame_ctx_p->call_operation == VM_EXEC_SUPER_CALL)), 0)) { jerry_assert_fail ("frame_ctx_p->call_operation == VM_EXEC_SUPER_CALL", "sao-vm.c", __func__, 393); } } while (0);
 do { if (__builtin_expect(!!(!(frame_ctx_p->byte_code_p[0] == CBC_EXT_OPCODE)), 0)) { jerry_assert_fail ("frame_ctx_p->byte_code_p[0] == CBC_EXT_OPCODE", "sao-vm.c", __func__, 394); } } while (0);
   ...
   case CBC_INITIALIZE_VARS:
    {
     ...
     while (literal_index <= literal_index_end)
     {
      ...
      else
      {
       ...
       if (__builtin_expect(!!(!is_immutable_binding), 1))
       {
        vm_var_decl (frame_ctx_p, name_p);
        ...
        do { if (__builtin_expect(!!(!(ecma_is_value_boolean (put_value_result) || ecma_is_value_empty (put_value_result) || (__builtin_expect(!!((put_value_result) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("ecma_is_value_boolean (put_value_result) || ecma_is_value_empty (put_value_result) || ECMA_IS_VALUE_ERROR (put_value_result)", "sao-vm.c", __func__, 761); } } while (0);



        if ((__builtin_expect(!!((put_value_result) == ECMA_VALUE_ERROR), 0)))
        {
...
# 793 "sao-vm.c"
 ...
 static ecma_value_t __attribute__((noinline))
 ...
 while (1)
 {
  ...
  while (1)
  {
   ...
   if (operands >= VM_OC_GET_LITERAL)
   {
    ...
    do { (literal_index) = *byte_code_p++; if ((literal_index) >= encoding_limit) { (literal_index) = (uint16_t) ((((literal_index) << 8) | *byte_code_p++) - encoding_delta); } } while (0);
    do { if ((literal_index) < ident_end) { if ((literal_index) < register_end) { (left_value) = ecma_fast_copy_value (frame_ctx_p->registers_p[literal_index]); } else { ecma_string_t *name_p = ecma_get_string_from_value (literal_start_p[literal_index]); result = ecma_op_resolve_reference_value (frame_ctx_p->lex_env_p, name_p); if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0))) { goto error; } (left_value) = result; } } else if (literal_index < const_literal_end) { (left_value) = ecma_fast_copy_value (literal_start_p[literal_index]); } else { (left_value) = vm_construct_literal_object (frame_ctx_p, literal_start_p[literal_index]); } } while (0);
    ...
    if (operands != VM_OC_GET_LITERAL)
    {
     switch (operands)
     {
      case VM_OC_GET_LITERAL_LITERAL:
       {
        ...
        do { if ((second_literal_index) < ident_end) { if ((second_literal_index) < register_end) { (right_value) = ecma_fast_copy_value (frame_ctx_p->registers_p[second_literal_index]); } else { ecma_string_t *name_p = ecma_get_string_from_value (literal_start_p[second_literal_index]); result = ecma_op_resolve_reference_value (frame_ctx_p->lex_env_p, name_p); if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0))) { goto error; } (right_value) = result; } } else if (second_literal_index < const_literal_end) { (right_value) = ecma_fast_copy_value (literal_start_p[second_literal_index]); } else { (right_value) = vm_construct_literal_object (frame_ctx_p, literal_start_p[second_literal_index]); } } while (0);
        break;
       }
      case VM_OC_GET_STACK_LITERAL:
       {
        do { if (__builtin_expect(!!(!(stack_top_p > frame_ctx_p->registers_p + register_end)), 0)) { jerry_assert_fail ("stack_top_p > frame_ctx_p->registers_p + register_end", "sao-vm.c", __func__, 899); } } while (0);
      ...
      default:
       {
        do { if (__builtin_expect(!!(!(operands == VM_OC_GET_THIS_LITERAL)), 0)) { jerry_assert_fail ("operands == VM_OC_GET_THIS_LITERAL", "sao-vm.c", __func__, 906); } } while (0);
   ...
   {
    do { if (__builtin_expect(!!(!(operands == VM_OC_GET_STACK || operands == VM_OC_GET_STACK_STACK)), 0)) { jerry_assert_fail ("operands == VM_OC_GET_STACK || operands == VM_OC_GET_STACK_STACK", "sao-vm.c", __func__, 918); } } while (0);


    do { if (__builtin_expect(!!(!(stack_top_p > frame_ctx_p->registers_p + register_end)), 0)) { jerry_assert_fail ("stack_top_p > frame_ctx_p->registers_p + register_end", "sao-vm.c", __func__, 920); } } while (0);
    left_value = *(--stack_top_p);

    if (operands == VM_OC_GET_STACK_STACK)
    {
     do { if (__builtin_expect(!!(!(stack_top_p > frame_ctx_p->registers_p + register_end)), 0)) { jerry_assert_fail ("stack_top_p > frame_ctx_p->registers_p + register_end", "sao-vm.c", __func__, 925); } } while (0);
     right_value = left_value;
     left_value = *(--stack_top_p);
    }
   }
   else if (operands == VM_OC_GET_BRANCH)
   {
    ...
    do { if (__builtin_expect(!!(!(branch_offset_length >= 1 && branch_offset_length <= 3)), 0)) { jerry_assert_fail ("branch_offset_length >= 1 && branch_offset_length <= 3", "sao-vm.c", __func__, 933); } } while (0);

    branch_offset = *(byte_code_p++);

    if (__builtin_expect(!!(branch_offset_length != 1), 0))
    {
     branch_offset <<= 8;
     branch_offset |= *(byte_code_p++);

     if (__builtin_expect(!!(branch_offset_length == 3), 0))
     {
      branch_offset <<= 8;
      branch_offset |= *(byte_code_p++);
     }
...
# 981 "sao-vm.c"
   ...
   switch (((opcode_data) & 0x7f))
   {
    case VM_OC_POP:
     {
      do { if (__builtin_expect(!!(!(stack_top_p > frame_ctx_p->registers_p + register_end)), 0)) { jerry_assert_fail ("stack_top_p > frame_ctx_p->registers_p + register_end", "sao-vm.c", __func__, 989); } } while (0);
      ecma_free_value (*(--stack_top_p));
      continue;
     }
    ...
    case VM_OC_SET_PROPERTY:
     {
      ...
      do { if (__builtin_expect(!!(!((opcode_data >> 14) <= 0x1)), 0)) { jerry_assert_fail ("(opcode_data >> VM_OC_NON_STATIC_SHIFT) <= 0x1", "sao-vm.c", __func__, 1113); } } while (0);

      result = right_value;

      if (__builtin_expect(!!(!ecma_is_value_string (right_value)), 0))
      {
       result = ecma_op_to_string (right_value);

       if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0)))
       {
        goto error;
       }
      }
      ...
      if (__builtin_expect(!!(ecma_compare_ecma_string_to_magic_id (prop_name_p, LIT_MAGIC_STRING_PROTOTYPE)), 0)
        && !(opcode_data & (0x1 << 14)))
      {
    ...
    case VM_OC_SET_SETTER:
     {
      do { if (__builtin_expect(!!(!((opcode_data >> 14) <= 0x1)), 0)) { jerry_assert_fail ("(opcode_data >> VM_OC_NON_STATIC_SHIFT) <= 0x1", "sao-vm.c", __func__, 1183); } } while (0);

      result = left_value;

      if (__builtin_expect(!!(!ecma_is_value_string (left_value)), 0))
      {
    ...
    case VM_OC_CLASS_HERITAGE:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 1286); } } while (0);
      ...
      else
      {
       ...
       if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0)) || !ecma_is_constructor (result))
       {
        if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0)))
        {
         ecma_free_value ((jerry_global_context.error_value));
    ...
    case VM_OC_CLASS_INHERITANCE:
     {
      ...
      if (ecma_get_object_prototype (super_class_p))
      {
       ...
       if (!((__builtin_expect(!!((super_prototype_value) == ECMA_VALUE_ERROR), 0)) || !ecma_is_value_object (super_prototype_value)))
       {
        ecma_object_t *super_prototype_class_p = ecma_get_object_from_value (super_prototype_value);

        do { void *ptr_value = (void *) super_prototype_class_p; if (__builtin_expect(!!((ptr_value) == ((void*)0)), 0)) { (child_prototype_class_p->prototype_or_outer_reference_cp) = ((jmem_cpointer_t) 0); } else { (child_prototype_class_p->prototype_or_outer_reference_cp) = jmem_compress_pointer (ptr_value); } } while (0);;
        do { void *ptr_value = (void *) super_class_p; if (__builtin_expect(!!((ptr_value) == ((void*)0)), 0)) { (child_class_p->prototype_or_outer_reference_cp) = ((jmem_cpointer_t) 0); } else { (child_class_p->prototype_or_outer_reference_cp) = jmem_compress_pointer (ptr_value); } } while (0);;
    ...
    case VM_OC_CLASS_EXPR_CONTEXT_END:
     {
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p - 1)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p - 1", "sao-vm.c", __func__, 1431); } } while (0);

      do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-2]) & 0xf)) == VM_CONTEXT_SUPER_CLASS)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-2]) == VM_CONTEXT_SUPER_CLASS", "sao-vm.c", __func__, 1433); } } while (0);
      stack_top_p = vm_stack_context_abort (frame_ctx_p, stack_top_p - 1);

      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 1436); } } while (0);
      stack_top_p++;
    ...
    case VM_OC_PUSH_CONSTRUCTOR_SUPER:
     {
      do { if (__builtin_expect(!!(!(byte_code_start_p[0] == CBC_EXT_OPCODE)), 0)) { jerry_assert_fail ("byte_code_start_p[0] == CBC_EXT_OPCODE", "sao-vm.c", __func__, 1448); } } while (0);
    ...
    case VM_OC_PUSH_SUPER:
     {
      do { if (__builtin_expect(!!(!(byte_code_start_p[0] == CBC_EXT_OPCODE)), 0)) { jerry_assert_fail ("byte_code_start_p[0] == CBC_EXT_OPCODE", "sao-vm.c", __func__, 1474); } } while (0);
        ...
        || byte_code_start_p[1] == CBC_EXT_PUSH_CONSTRUCTOR_SUPER_PROP)
      {
       ...
       if ((__builtin_expect(!!((super_prototype) == ECMA_VALUE_ERROR), 0)))
       {
    ...
    case VM_OC_APPEND_ARRAY:
     {
      ...
      for (uint32_t i = 0; i < values_length; i++)
      {
       if (!ecma_is_value_array_hole (stack_top_p[i]))
       {
        ...
        do { if (__builtin_expect(!!(!(ecma_is_value_undefined (prop_value_p->value))), 0)) { jerry_assert_fail ("ecma_is_value_undefined (prop_value_p->value)", "sao-vm.c", __func__, 1575); } } while (0);
    ...
    case VM_OC_IDENT_REFERENCE:
     {
      ...
      do { if (__builtin_expect(!!(!(literal_index < ident_end)), 0)) { jerry_assert_fail ("literal_index < ident_end", "sao-vm.c", __func__, 1606); } } while (0);
    ...
    case VM_OC_PROP_REFERENCE:
     {
      ...
      {
       do { if (__builtin_expect(!!(!(opcode == CBC_PUSH_PROP_LITERAL_LITERAL_REFERENCE || opcode == CBC_PUSH_PROP_THIS_LITERAL_REFERENCE)), 0)) { jerry_assert_fail ("opcode == CBC_PUSH_PROP_LITERAL_LITERAL_REFERENCE || opcode == CBC_PUSH_PROP_THIS_LITERAL_REFERENCE", "sao-vm.c", __func__, 1657); } } while (0);
    ...
    case VM_OC_POST_DECR:
     {
      ...
      if (ecma_is_value_integer_number (left_value))
      {
       ...
       if (__builtin_expect(!!(int_increase != 0), 1))
       {
        ...
        if (opcode_flags & 0x2)
        {
         if (opcode_data & VM_OC_PUT_STACK)
         {
          if (opcode_flags & 0x4)
          {
           do { if (__builtin_expect(!!(!(opcode == CBC_POST_INCR_IDENT_PUSH_RESULT || opcode == CBC_POST_DECR_IDENT_PUSH_RESULT)), 0)) { jerry_assert_fail ("opcode == CBC_POST_INCR_IDENT_PUSH_RESULT || opcode == CBC_POST_DECR_IDENT_PUSH_RESULT", "sao-vm.c", __func__, 1736); } } while (0);
          ...
          else
          {
           ...
           do { if (__builtin_expect(!!(!(opcode == CBC_POST_INCR_PUSH_RESULT || opcode == CBC_POST_DECR_PUSH_RESULT)), 0)) { jerry_assert_fail ("opcode == CBC_POST_INCR_PUSH_RESULT || opcode == CBC_POST_DECR_PUSH_RESULT", "sao-vm.c", __func__, 1746); } } while (0);
      ...
      if (opcode_flags & 0x2)
      {
       if (opcode_data & VM_OC_PUT_STACK)
       {
        if (opcode_flags & 0x4)
        {
         do { if (__builtin_expect(!!(!(opcode == CBC_POST_INCR_IDENT_PUSH_RESULT || opcode == CBC_POST_DECR_IDENT_PUSH_RESULT)), 0)) { jerry_assert_fail ("opcode == CBC_POST_INCR_IDENT_PUSH_RESULT || opcode == CBC_POST_DECR_IDENT_PUSH_RESULT", "sao-vm.c", __func__, 1799); } } while (0);
        ...
        else
        {
         ...
         do { if (__builtin_expect(!!(!(opcode == CBC_POST_INCR_PUSH_RESULT || opcode == CBC_POST_DECR_PUSH_RESULT)), 0)) { jerry_assert_fail ("opcode == CBC_POST_INCR_PUSH_RESULT || opcode == CBC_POST_DECR_PUSH_RESULT", "sao-vm.c", __func__, 1809); } } while (0);
    ...
    case VM_OC_RET:
     {
      do { if (__builtin_expect(!!(!(opcode == CBC_RETURN || opcode == CBC_RETURN_WITH_BLOCK || opcode == CBC_RETURN_WITH_LITERAL)), 0)) { jerry_assert_fail ("opcode == CBC_RETURN || opcode == CBC_RETURN_WITH_BLOCK || opcode == CBC_RETURN_WITH_LITERAL", "sao-vm.c", __func__, 1861); } } while (0);
    ...
    case VM_OC_EVAL:
     {
      ...
      do { if (__builtin_expect(!!(!(*byte_code_p >= CBC_CALL && *byte_code_p <= CBC_CALL2_PROP_BLOCK)), 0)) { jerry_assert_fail ("*byte_code_p >= CBC_CALL && *byte_code_p <= CBC_CALL2_PROP_BLOCK", "sao-vm.c", __func__, 1890); } } while (0);
      continue;
     }
    case VM_OC_CALL:
     {
    ...
    case VM_OC_PROP_DELETE:
     {
      ...
      do { if (__builtin_expect(!!(!(ecma_is_value_boolean (result))), 0)) { jerry_assert_fail ("ecma_is_value_boolean (result)", "sao-vm.c", __func__, 1972); } } while (0);
    ...
    case VM_OC_DELETE:
     {
      ...
      do { if (__builtin_expect(!!(!(ecma_is_value_boolean (result))), 0)) { jerry_assert_fail ("ecma_is_value_boolean (result)", "sao-vm.c", __func__, 1997); } } while (0);
    ...
    case VM_OC_BRANCH_IF_STRICT_EQUAL:
     {
      ...
      do { if (__builtin_expect(!!(!(stack_top_p > frame_ctx_p->registers_p + register_end)), 0)) { jerry_assert_fail ("stack_top_p > frame_ctx_p->registers_p + register_end", "sao-vm.c", __func__, 2011); } } while (0);
    ...
    case VM_OC_TYPEOF_IDENT:
     {
      ...
      do { if (__builtin_expect(!!(!(literal_index < ident_end)), 0)) { jerry_assert_fail ("literal_index < ident_end", "sao-vm.c", __func__, 2109); } } while (0);
    ...
    case VM_OC_SUB:
     {
      ...
      do { if (__builtin_expect(!!(!(!(__builtin_expect(!!((left_value) == ECMA_VALUE_ERROR), 0)) && !(__builtin_expect(!!((right_value) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("!ECMA_IS_VALUE_ERROR (left_value) && !ECMA_IS_VALUE_ERROR (right_value)", "sao-vm.c", __func__, 2202); } } while (0);
    ...
    case VM_OC_MUL:
     {
      do { if (__builtin_expect(!!(!(!(__builtin_expect(!!((left_value) == ECMA_VALUE_ERROR), 0)) && !(__builtin_expect(!!((right_value) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("!ECMA_IS_VALUE_ERROR (left_value) && !ECMA_IS_VALUE_ERROR (right_value)", "sao-vm.c", __func__, 2247); } } while (0);
    ...
    case VM_OC_DIV:
     {
      do { if (__builtin_expect(!!(!(!(__builtin_expect(!!((left_value) == ECMA_VALUE_ERROR), 0)) && !(__builtin_expect(!!((right_value) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("!ECMA_IS_VALUE_ERROR (left_value) && !ECMA_IS_VALUE_ERROR (right_value)", "sao-vm.c", __func__, 2309); } } while (0);
    ...
    case VM_OC_MOD:
     {
      do { if (__builtin_expect(!!(!(!(__builtin_expect(!!((left_value) == ECMA_VALUE_ERROR), 0)) && !(__builtin_expect(!!((right_value) == ECMA_VALUE_ERROR), 0)))), 0)) { jerry_assert_fail ("!ECMA_IS_VALUE_ERROR (left_value) && !ECMA_IS_VALUE_ERROR (right_value)", "sao-vm.c", __func__, 2324); } } while (0);
    ...
    case VM_OC_LESS:
     {
      if (ecma_are_values_integer_numbers (left_value, right_value))
      {
       ...
       if (*byte_code_p <= CBC_BRANCH_IF_TRUE_BACKWARD_3 && *byte_code_p >= CBC_BRANCH_IF_TRUE_BACKWARD)
       {
        ...
        do { if (__builtin_expect(!!(!(branch_offset_length >= 1 && branch_offset_length <= 3)), 0)) { jerry_assert_fail ("branch_offset_length >= 1 && branch_offset_length <= 3", "sao-vm.c", __func__, 2539); } } while (0);
    ...
    case VM_OC_WITH:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2712); } } while (0);
    ...
    case VM_OC_FOR_IN_CREATE_CONTEXT:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2741); } } while (0);
      ...
      do { void *ptr_value = (void *) prop_names_p; if (__builtin_expect(!!((ptr_value) == ((void*)0)), 0)) { (stack_top_p[-2]) = ((jmem_cpointer_t) 0); } else { (stack_top_p[-2]) = jmem_compress_pointer (ptr_value); } } while (0);;
      stack_top_p[-3] = 0;
    ...
    case VM_OC_FOR_IN_GET_NEXT:
     {
      ...
      chunk_p = (((__builtin_expect(!!((context_top_p[-2]) == ((jmem_cpointer_t) 0)), 0)) ? ((void*)0) : ((ecma_collection_chunk_t *) (jmem_decompress_pointer (context_top_p[-2])))));

      do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((context_top_p[-1]) & 0xf)) == VM_CONTEXT_FOR_IN)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (context_top_p[-1]) == VM_CONTEXT_FOR_IN", "sao-vm.c", __func__, 2771); } } while (0);

      uint32_t index = context_top_p[-3];

      do { if (__builtin_expect(!!(!(!ecma_is_value_pointer (chunk_p->items[index]))), 0)) { jerry_assert_fail ("!ecma_is_value_pointer (chunk_p->items[index])", "sao-vm.c", __func__, 2775); } } while (0);

      *stack_top_p++ = chunk_p->items[index];
      index++;

      if (__builtin_expect(!!(!ecma_is_value_pointer (chunk_p->items[index])), 1))
      {
      ...
      do { void *ptr_value = (void *) next_chunk_p; if (__builtin_expect(!!((ptr_value) == ((void*)0)), 0)) { (context_top_p[-2]) = ((jmem_cpointer_t) 0); } else { (context_top_p[-2]) = jmem_compress_pointer (ptr_value); } } while (0);;
    ...
    case VM_OC_FOR_IN_HAS_NEXT:
     {
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2797); } } while (0);

      ecma_collection_chunk_t *chunk_p;
      chunk_p = (((__builtin_expect(!!((stack_top_p[-2]) == ((jmem_cpointer_t) 0)), 0)) ? ((void*)0) : ((ecma_collection_chunk_t *) (jmem_decompress_pointer (stack_top_p[-2])))));
      ...
      while (1)
      {
       ...
       if (__builtin_expect(!!(ecma_op_object_has_property (object_p, prop_name_p)), 1))
       {
        byte_code_p = byte_code_start_p + branch_offset;
        break;
       }
       ...
       if (__builtin_expect(!!(!ecma_is_value_pointer (value)), 1))
       {
        stack_top_p[-3] = index;
       }
       else
       {
        ...
        do { void *ptr_value = (void *) next_chunk_p; if (__builtin_expect(!!((ptr_value) == ((void*)0)), 0)) { (stack_top_p[-2]) = ((jmem_cpointer_t) 0); } else { (stack_top_p[-2]) = jmem_compress_pointer (ptr_value); } } while (0);;
    ...
    case VM_OC_TRY:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2853); } } while (0);
    ...
    case VM_OC_CATCH:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2864); } } while (0);
      do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_TRY)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_TRY", "sao-vm.c", __func__, 2865); } } while (0);
    ...
    case VM_OC_FINALLY:
     {
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2874); } } while (0);

      do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_TRY || ((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_CATCH)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_TRY || VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_CATCH", "sao-vm.c", __func__, 2877); } } while (0);
    ...
    case VM_OC_CONTEXT_END:
     {
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2892); } } while (0);
       ...
       case VM_CONTEXT_FINALLY_JUMP:
        {
         ...
         if (vm_stack_find_finally (frame_ctx_p,
            ...
            jump_target))
         {
          do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_FINALLY_JUMP)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_FINALLY_JUMP", "sao-vm.c", __func__, 2909); } } while (0);
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2949); } } while (0);
      continue;
     }
    case VM_OC_JUMP_AND_EXIT_CONTEXT:
     {
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2954); } } while (0);
      ...
      {
       do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_FINALLY_JUMP)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_FINALLY_JUMP", "sao-vm.c", __func__, 2963); } } while (0);
       byte_code_p = frame_ctx_p->byte_code_p;
      ...
      do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 2972); } } while (0);
      continue;
     }
# 3096 "sao-vm.c"
    default:
     {
      do { if (__builtin_expect(!!(!(((opcode_data) & 0x7f) == VM_OC_NONE)), 0)) { jerry_assert_fail ("VM_OC_GROUP_GET_INDEX (opcode_data) == VM_OC_NONE", "sao-vm.c", __func__, 3098); } } while (0);
   ...
   do { if (__builtin_expect(!!(!(((opcode_data) & (0xf << 10)))), 0)) { jerry_assert_fail ("VM_OC_HAS_PUT_RESULT (opcode_data)", "sao-vm.c", __func__, 3105); } } while (0);
   ...
   else if (opcode_data & VM_OC_PUT_REFERENCE)
   {
    ...
    else
    {
     ...
     if ((__builtin_expect(!!((set_value_result) == ECMA_VALUE_ERROR), 0)))
     {
      ecma_free_value (result);
...
error:
  ...
  if ((__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0)))
  {
     ...
     vm_stack_p++)
   {
    ...
    {
     do { if (__builtin_expect(!!(!(vm_stack_p < stack_top_p)), 0)) { jerry_assert_fail ("vm_stack_p < stack_top_p", "sao-vm.c", __func__, 3218); } } while (0);
     vm_stack_p++;
    }
    else
    {
...
# 3258 "sao-vm.c"
  ...
  do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 3260); } } while (0);
  ...
  if (!(__builtin_expect(!!((result) == ECMA_VALUE_ERROR), 0)))
  {
   if (vm_stack_find_finally (frame_ctx_p,
      ...
      0))
   {
    do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_FINALLY_RETURN)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_FINALLY_RETURN", "sao-vm.c", __func__, 3277); } } while (0);
    do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 3278); } } while (0);
  ...
  else if ((jerry_global_context.status_flags) & ECMA_STATUS_EXCEPTION)
  {
   if (vm_stack_find_finally (frame_ctx_p,
      ...
      0))
   {
    do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 3292); } } while (0);
     ...
     *stack_top_p++ = (jerry_global_context.error_value);
     ...
     do { if (__builtin_expect(!!(!(byte_code_p[0] == CBC_ASSIGN_SET_IDENT)), 0)) { jerry_assert_fail ("byte_code_p[0] == CBC_ASSIGN_SET_IDENT", "sao-vm.c", __func__, 3304); } } while (0);
    ...
    {
     do { if (__builtin_expect(!!(!(((vm_stack_context_type_t) ((stack_top_p[-1]) & 0xf)) == VM_CONTEXT_FINALLY_THROW)), 0)) { jerry_assert_fail ("VM_GET_CONTEXT_TYPE (stack_top_p[-1]) == VM_CONTEXT_FINALLY_THROW", "sao-vm.c", __func__, 3325); } } while (0);
  ...
  else
  {
   do
   {
    do { if (__builtin_expect(!!(!(frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p)), 0)) { jerry_assert_fail ("frame_ctx_p->registers_p + register_end + frame_ctx_p->context_depth == stack_top_p", "sao-vm.c", __func__, 3336); } } while (0);
  ...
  ecma_length_t arg_list_len)
{
 ...
 while (1)
 {
  ...
  {
   do { if (__builtin_expect(!!(!(frame_ctx_p->call_operation == VM_EXEC_CONSTRUCT)), 0)) { jerry_assert_fail ("frame_ctx_p->call_operation == VM_EXEC_CONSTRUCT", "sao-vm.c", __func__, 3432); } } while (0);
