/* armflush.c - flush the instruction cache
   ...
   __clear_cache is used in sccrun.c,  It is a built-in
...
/* arm-scc supports only fake asm currently */
__asm__(
    ".global syscall\n"
    "syscall:\n"
    ".int 0xe92d4080\n"  // push    {r7, lr}
 ...
 * However, there is no ARM asm parser in scc so we use it for now */
#if 1
